// Handles everything related GPUComputationRenderer
// It is utilized by the PigeonManager. 

import * as THREE from 'three'
import { WIDTH } from './Pigeon';
...
class GPURenderer {
    constructor(renderer, effectController) {
        ...
        this.velocityUniforms["separationDistance"] = { value: effectController.seperation };
